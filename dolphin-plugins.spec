...
Version  : 22.12.2
Release  : 47
URL      : https://download.kde.org/stable/release-service/22.12.2/src/dolphin-plugins-22.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.2/src/dolphin-plugins-22.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.2/src/dolphin-plugins-22.12.2.tar.xz.sig
...
%prep
%setup -q -n dolphin-plugins-22.12.2
cd %{_builddir}/dolphin-plugins-22.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675649368
mkdir -p clr-build
pushd clr-build
