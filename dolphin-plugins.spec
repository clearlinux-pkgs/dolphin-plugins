...
Version  : 24.02.2
Release  : 65
URL      : https://download.kde.org/stable/release-service/24.02.2/src/dolphin-plugins-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/dolphin-plugins-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/dolphin-plugins-24.02.2.tar.xz.sig
...
%setup -q -n dolphin-plugins-24.02.2
cd %{_builddir}/dolphin-plugins-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713282090
mkdir -p clr-build
pushd clr-build
