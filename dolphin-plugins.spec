...
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/dolphin-plugins-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/dolphin-plugins-22.04.2.tar.xz.sig
...
%prep
%setup -q -n dolphin-plugins-22.04.2
cd %{_builddir}/dolphin-plugins-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655131935
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/dolphin-plugins-22.04.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/dolphin-plugins/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
