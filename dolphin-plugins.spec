...
Version  : 22.12.3
Release  : 49
URL      : https://download.kde.org/stable/release-service/22.12.3/src/dolphin-plugins-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/dolphin-plugins-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/dolphin-plugins-22.12.3.tar.xz.sig
...
%prep
%setup -q -n dolphin-plugins-22.12.3
cd %{_builddir}/dolphin-plugins-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677786715
mkdir -p clr-build
pushd clr-build
