...
Source0  : https://download.kde.org/stable/applications/19.04.2/src/dolphin-plugins-19.04.2.tar.xz
Source99 : https://download.kde.org/stable/applications/19.04.2/src/dolphin-plugins-19.04.2.tar.xz.sig
...
%prep
%setup -q -n dolphin-plugins-19.04.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1559879989
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
