...
Version  : 20.04.0
Release  : 18
URL      : https://download.kde.org/stable/release-service/20.04.0/src/dolphin-plugins-20.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.04.0/src/dolphin-plugins-20.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.0/src/dolphin-plugins-20.04.0.tar.xz.sig
...
%prep
%setup -q -n dolphin-plugins-20.04.0
cd %{_builddir}/dolphin-plugins-20.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587672204
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/dolphin-plugins-20.04.0/COPYING %{buildroot}/usr/share/package-licenses/dolphin-plugins/7c203dee3a03037da436df03c4b25b659c073976
pushd clr-build
%make_install
popd
