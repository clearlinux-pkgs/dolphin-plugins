...
Version  : 24.12.1
Release  : 77
URL      : https://download.kde.org/stable/release-service/24.12.1/src/dolphin-plugins-24.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/dolphin-plugins-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/dolphin-plugins-24.12.1.tar.xz.sig
...
%setup -q -n dolphin-plugins-24.12.1
cd %{_builddir}/dolphin-plugins-24.12.1
pushd ..
cp -a dolphin-plugins-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736531324
mkdir -p clr-build
pushd clr-build
