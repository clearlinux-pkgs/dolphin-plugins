...
Version  : 22.12.1
Release  : 46
URL      : https://download.kde.org/stable/release-service/22.12.1/src/dolphin-plugins-22.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/dolphin-plugins-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/dolphin-plugins-22.12.1.tar.xz.sig
...
%prep
%setup -q -n dolphin-plugins-22.12.1
cd %{_builddir}/dolphin-plugins-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673294246
mkdir -p clr-build
pushd clr-build
