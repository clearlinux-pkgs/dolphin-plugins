...
Source0  : https://download.kde.org/stable/release-service/19.12.3/src/dolphin-plugins-19.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.3/src/dolphin-plugins-19.12.3.tar.xz.sig
...
%prep
%setup -q -n dolphin-plugins-19.12.3
cd %{_builddir}/dolphin-plugins-19.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583434290
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/dolphin-plugins-19.12.3/COPYING %{buildroot}/usr/share/package-licenses/dolphin-plugins/7c203dee3a03037da436df03c4b25b659c073976
pushd clr-build
%make_install
popd
